...
//     checkAIService,
//     [
//         body('section').isString().isIn(['experience', 'projects', 'education', 'achievements', 'areasOfInterest', 'positionOfResponsibility']),
...
//                     case 'achievements':
//                         prompt = `Enhance this achievement highlighting measurable impact and recognition.

// Original point: "${content}"
// ${context ? `Achievement Context: ${context}` : ''}
// ${jobDescription ? `Target Role: ${jobDescription}` : ''}

// ACHIEVEMENT ENHANCEMENT:
// - Use recognition/accomplishment verbs: Achieved, Earned, Recognized, Awarded, Selected, Honored
// - Highlight competition scope, selection criteria, or achievement significance
// - Include measurable impact: rankings, percentages, or competitive metrics
// - Show excellence, distinction, and standout performance
// - Connect to ${jobRole} career relevance when possible

// MANDATORY CHARACTER REQUIREMENTS:
// - MUST BE exactly 95 characters (one PDF line) OR 190 characters (two PDF lines)
// - Focus on achievement significance, competitive advantage, and measurable distinction

// Return ONLY the enhanced achievement statement meeting character requirements.`;
//                         break;
...
- **Target: 15-25 words** for concise impact OR **30-40 words** for detailed description
